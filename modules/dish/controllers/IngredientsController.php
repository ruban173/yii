...
use app\modules\dish\models\IngredientsSearch;
...
class IngredientsController extends Controller
{
    ...
    {
       $this->viewPath= dirname(__DIR__).'\views\ingredients';
        return [
            'verbs' => [
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validationCountRecords() ) {
            $model->save();
